...
<body>
	...
	<form action="/lisaa-peli" method="post">
		...
		<p>
			<label>Julkaisupaiva:</label> <input type="text" value="" name="julkaisupaiva"
				size="50" />
		</p>
				<p>
			<label>Lajityyppi:</label> <input type="text" value="" name="lajityyppi"
				size="50" />
		</p>
				<p>
			<label>Kehittaja:</label> <input type="text" value="" name="kehittaja"
				size="50" />
		</p>
